...
Projects should have Managers who have the ability to create/edit/delete boards. Boards should have their own Members, so members won't see all boards, just those they belong to. Ualtec will be released after this breaking change.
...
**Please note that Ualtec is NOT released yet, API and database structure may be changed!**
...
Ualtec is [MIT licensed](https://github.com/plankanban/planka/blob/master/LICENSE).
